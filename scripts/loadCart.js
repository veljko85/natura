      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let natura180180GrauCart = 0;
            let natura90180GrauCart = 0;
            let natura180180BraunCart = 0;
            let natura90180BraunCart = 0;
            for (let i = 0; i < allFences.length; i++) {
              if (fencesArr[i].color == "braun") {
                if (allFences[i][0].isVisible) natura180180BraunCart += 1;
                if (allFences[i][1].isVisible) natura90180BraunCart += 1;
              }
              if (fencesArr[i].color == "grau") {
                if (allFences[i][0].isVisible) natura180180GrauCart += 1;
                if (allFences[i][1].isVisible) natura90180GrauCart += 1;
              }
            }

            //populate wooden posts
            let woodenPost190Grau = 0;
            let woodenPost190Braun = 0;
            ...
            cartItems = [];
            cartItems.push(
              natura180180GrauCart,
              natura90180GrauCart,
              natura180180BraunCart,
              natura90180BraunCart,
              woodenPost190Grau,
              woodenPost190Braun,
